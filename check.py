...
def get_S2(quarter, product):
    s2_data = []
    with open('C:\Users\Administrator\Desktop\Dashboard\dashboard_quantum\checks\CheckS2.csv', newline='') as csvfile:
...
def get_StatRes(quarter, product):
    statres_data = []
    with open('C:\Users\Administrator\Desktop\Dashboard\dashboard_quantum\checks\CheckStatRes.csv', newline='') as csvfile:
        import_file = csv.reader(csvfile, delimiter=',')
        for row in import_file:
...
def get_policies(quarter, product):
    policy_data = []
    with open('C:\Users\Administrator\Desktop\Dashboard\dashboard_quantum\checks\CheckNoPolicies.csv', newline='') as csvfile:
        import_file = csv.reader(csvfile, delimiter=',')
        for row in import_file:
